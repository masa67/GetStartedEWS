...
namespace GetStartedEWS
{
    class Program
    {
      ...
      "</soap:Envelope>\n";
            ...
            var getFolderRequest = WebRequest.CreateHttp("https://outlook.office365.com/ews/exchange.asmx");
      ...
      "          <t:ToRecipients>\n" +
      "            <t:Mailbox>\n" +
      "              <t:EmailAddress>" + userCredentials.UserName + "</t:EmailAddress>\n" +
      "              </t:Mailbox>\n" +
      "          </t:ToRecipients>\n" +
      "        </t:Message>\n" +
      "      </m:Items>\n" +
